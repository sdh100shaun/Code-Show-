...
<body>
<ul>
    <li>${resources.expand}</li>
    <li>${resources.link.rel}</li>
    <li>${resources.link.href}</li>
    <li>${resources.resources.size}</li>
    <li>${resources.resources.maxSize}</li>
    <li>${resources.resources.startIndex}</li>
</ul>
</body>
</html>
